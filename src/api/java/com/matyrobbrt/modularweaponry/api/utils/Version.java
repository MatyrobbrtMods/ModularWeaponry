...
public class Version {
     ...
     *
     * @implNote We don't currently include the artifact version's build number as
     *           we classify our version by major, minor, build
     */
    ...
    /**
     * Helper to make it so this is the only class with weird errors in IntelliJ
     * (that don't actually exist), instead of having our main class also have
     * "errors"
     */
